	...
	\eject
		...
		\end{itemize}
			...
			\subsection{Opis tablica}
				...
				\noindent\textbf{Korisnik} Ovaj entitet sadržava sve važne informacije o korisniku aplikacije. Sadrži atribute: id korisnika, nadimak, korisničko ime, email, salt, lozinka i suspendiran. Ovaj entitet u vezi je Many-to-Many s ImaUlogu preko korisničkog identifikatora, u vezi Many-to-Many s JePrijatelj preko korisničkog identifikatora, u vezi Many-to-Many s JeBlokiranOd preko korisničkog identifikatora, te u vezi  One-to-Many s entitetom Događaj preko korisničkog identifikatora i u vezi Many-to-Many s entitetom Pohadja preko korisničkog identifikatora.
				...
				\noindent\textbf{Uloga} Ovaj entitet sadržava sve važne informacije o ulogama korisnika. Sadrži atribute: id uloga, naziv uloga i opis uloga. Ovaj entitet u vezi je Many-to-Many s imaUloga preko identifikatora uloge.
				...
				\noindent\textbf{Vrsta} Ovaj entitet sadržava sve važne informacije o vrstama događaja. Sadrži atribute: id vrsta, naziv vrsta i opis vrsta. Ovaj entitet u vezi je One-to-Many s entitetom Dogadjaj preko identifikatora vrste.
				...
				\noindent\textbf{Oznaka} Ovaj entitet sadržava sve važne informacije o oznakama događaja. Sadrži atribute: id oznaka, naziv oznaka i boja hex. Ovaj entitet u vezi je Many-to-Many s ImaOznaku preko identifikatora oznake.
				...
				\noindent\textbf{ImaUlogu} Ovaj entitet sadržava sve važne informacije po kojima saznajemo koji korisnik ima koju ulogu. Sadrži atribute: id korisnik i id uloga. Ovaj entitet u vezi je Mnay-to-Many s entitetom Uloga preko identifikatora uloge te u Many-to-Many vezi s entitetom Korisnik preko identifikatora korisnika.
				...
				\noindent\textbf{JePrijatelj} Ovaj entitet sadržava sve važne informacije o tome koji je korisnik nekom drugom korisniku prijatelj. Sadrži atribute: id korisnik i id prijatelj. Ovaj entitet u vezi je Many-to-Many s entitetom Korisnik preko identifikatora korisnika.
				...
				\noindent\textbf{JeBlokiranOd} Ovaj entitet sadržava sve važne informacije o tome koji je korisnik blokiran i od kojeg je korisnika blokiran. Sadrži atribute: id blokiran i id blokiran od. Ovaje entitet u vezi je Many-to-Many s entitetom korisnik preko identifikatora korisnika.
				...
				\noindent\textbf{Dogadjaj} Ovaj entitet sadržava sve važne informacije o događaju. Sadrži atribute: id događaj, naziv, mjesto, vrijeme početka, vrijeme kraja, opis, promoviran, koordinate, id organizator i id vrsta. Ovaj entitet u vezi je Many-to-One s entitetom Vrsta preko identifikatora vrste, u vezi Many-to-Many s entitetom Korisnik preko identifikatora korisnika, u vezi Many-to-Many s Pohadja i s ImaOznaku preko identifikatora dogadjaja.
				...
				\noindent\textbf{Pohadja} Ovaj entitet sadržava sve važne informacije o tome tko je pohađao koji događaj i kako ga je ocijenio. Sadrži atribute: recenzija, id polaznika i id događaja. Ovaj entitet u vezi je Many-to-Many s entitetom Korisnik preko identifikatora korisnika te u vezi Many-to-Many s entitetom Dogadjaj preko identifikatora dogadjaja.
				...
				\noindent\textbf{ImaOznaku} Ovaj entitet sadržava sve važne informacije o oznakama određenih događaja. Sadrži atribute: id događaj i id oznaka. Ovaj entitet u vezi je Many-to-Many s entitetom Oznaka preko identifikatora oznake te u vezi Many-to-Many s entitetom Dogadjaj preko identifikatora dogadjaja.
